...
data_1 = pandas.read_excel('D:/Study/Prog/statistics/experiment_1.xlsx')
df_1 = pandas.DataFrame(data_1)
data_2 = pandas.read_excel('D:/Study/Prog/statistics/experiment_2.xlsx')
df_2 = pandas.DataFrame(data_2)
data_3 = pandas.read_excel('D:/Study/Prog/statistics/experiment_3.xlsx')
